...
-- This migration adds support for storing image type (THUMBNAIL, INTRO, MEDICAL, LIFESTYLE, WARNING, CTA, INFOGRAPHIC)
-- Date: 2025-10-18
...
COMMENT ON COLUMN blog_images.image_type IS 'Type of image: THUMBNAIL, INTRO, MEDICAL, LIFESTYLE, WARNING, CTA, or INFOGRAPHIC';
...
--   image_type IN ('THUMBNAIL', 'INTRO', 'MEDICAL', 'LIFESTYLE', 'WARNING', 'CTA', 'INFOGRAPHIC')
-- );
